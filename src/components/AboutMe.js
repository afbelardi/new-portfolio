        ...
        <div className="flex flex-col w-full p-4 mt-10 md:mt-48 min-h-400">
            ...
            <section className="flex flex-col items-center justify-center h-5/6">
                ...
                <div className="w-10/12 mt-8 text-justify md:w-9/12 lg:w-3/5 lg:text-lg lg:max-w-800">
                    <Fade up>
                        <p  className="text-lg text-white font-recoleta-light">My interest in technology began from a young age. By 13 years old, I was creating technology product review videos for my
                        YouTube channel. While partnering with major brands, I amassed a following of 7,000 subscribers and 2 million video views.
                        </p>
                    </Fade>
                    <Fade up>
                        <p className="mt-2 text-lg text-white font-recoleta-light">After graduating college, I started a job at an Apple retail store and worked my way up to the title of Genius. During that
